...
export const SUPABASE_URL='https://bodqpmgsncxvextwqxin.supabase.co';
export const SUPABASE_PUBLISHABLE_KEY='sb_publishable_7am-GmPUhFtYAPPb689zhQ_KWcD89H-';
const CONTROL_URL=`${SUPABASE_URL}/functions/v1/arena-control`;
